      ...
      {project && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex max-h-[90dvh] w-full max-w-2xl flex-col overflow-y-auto overscroll-contain rounded-[var(--radius-card)] bg-[color-mix(in_oklab,var(--color-surface-raised)_96%,transparent)] p-6 ring-1 ring-[var(--glass-border)] shadow-[0_40px_120px_-30px_rgb(0_0_0/0.9)] light:shadow-[0_40px_120px_-30px_rgb(24_44_86/0.45)] backdrop-blur-xl pb-[calc(1.5rem_+_env(safe-area-inset-bottom,0px))] sm:p-8"
          >
            <button
              type="button"
              onClick={close}
